...
MapGroup_Dungeons:
	...
	map CherrygroveCave, TILESET_CAVE, CAVE, LANDMARK_ROUTE_30, MUSIC_PRIMARINUM_CAVE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Violet:
	...
	map VioletHouse1, TILESET_HOUSE, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VioletHouse2, TILESET_HOUSE, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map CherrygrovePCM, TILESET_POKECENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CherrygroveHouse1, TILESET_HOUSE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygroveHouse2, TILESET_HOUSE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygroveHouse3, TILESET_HOUSE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygroveHouse4, TILESET_HOUSE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CHERRYGROVE_MAPS
	
MapGroup_Silbernium2:
	table_width MAP_LENGTH, MapGroup_Silbernium2
	map SilberniumOld, TILESET_JOHTO, ROUTE, LANDMARK_SILBERNIUMOLD, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
	assert_table_length NUM_SILBERNIUM_OLD_MAPS
