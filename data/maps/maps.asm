...
MapGroup_Violet:
	...
	map VioletCity, TILESET_JOHTO, TOWN, LANDMARK_VIOLET_CITY, MUSIC_OLDCITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
IF DEF(_DEBUG)
	map CherrygroveCity, TILESET_JOHTO, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_OLDCITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
ELSE
