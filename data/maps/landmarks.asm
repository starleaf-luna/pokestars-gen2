...
MahoganyTownName:    db "NAME TBD@"
BlackthornCityName:  db "NAME TBD@"
LakeOfRageName:      db "NAME TBD@"
SilverCaveName:      db "NAME TBD@"
SproutTowerName:     db "NAME TBD@"
RuinsOfAlphName:     db "NAME TBD@"
UnionCaveName:       db "NAME TBD@"
SlowpokeWellName:    db "NAME TBD@"
RadioTowerName:      db "NAME TBD@"
PowerPlantName:      db "NAME TBD@"
NationalParkName:    db "NAME TBD@"
TinTowerName:        db "NAME TBD@"
LighthouseName:      db "NAME TBD@"
WhirlIslandsName:    db "NAME TBD@"
